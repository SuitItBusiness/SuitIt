      ...
      <footer class="py-0 pt-7">
        <div class="container section-gray mb-5">
            <div class="row">
                ...
                <div class="col-6 col-lg-2 mb-3">
                    <h5 class="lh-lg fw-bold text-1000">Atención al cliente</h5>
                    <ul class="list-unstyled mb-md-4 mb-lg-0">
                        <li class="lh-lg"><a class="text-800 text-decoration-none" href="#!">Contacta con nosotros</a>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg-auto ms-auto">
                    <h5 class="lh-lg fw-bold text-1000">Inicia sesión</h5>
