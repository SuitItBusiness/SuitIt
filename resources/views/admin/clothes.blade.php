        ...
        <div class="container container-fluid mt-5">
            <div class="row">
                <div class="col-4 form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ $clothes->name }}"
                        required>
                </div>
            ...
            <div class="row">
                <div class="col-4 form-group">
                    ...
                    <input type="number" name="comfort_level" id="comfort_level" class="form-control"
                        value="{{ $clothes->comfort_level }}" required>
                </div>
                    ...
                    <select name="category_id" id="category" class="form-control" value="{{ $clothes->season }}" required>
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                {{ $category->id == $clothes->category_id ? 'selected' : '' }}>{{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
